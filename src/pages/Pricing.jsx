      ...
      <Container>
        <div className="py-30">
          <div className="mx-auto hedding text-center max-w-118">
            <div className="mb-7.5 heading mx-auto flex flex-col items-center  md:gap-y-3 font-bold leading-6.5">
              <p className="text-[24px] sm:text-2xl text-primary flex items-center">
                Our Teacher
            ...
            <div className="flex justify-center gap-3.5 mb-12">
              <button
                ...
                className={`py-[14.5px] px-8 rounded-[10px] font-semibold font-urbanist text-[16px] leading-6.5 ${billing === "monthly"
              ...
              <button
                ...
                className={`py-[14.5px] px-7.5 rounded-[10px] font-semibold font-urbanist text-[16px] leading-6.5 ${billing === "yearly"
                  ? "bg-[#F57005] text-white"
                  : "bg-[#E4E4E4] text-[#2A254D]"
                  }`}
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 px-3 md:py-0 gap-9 md:gap-5 lg:gap-9">
