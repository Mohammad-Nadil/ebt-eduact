  ...
  return (
    <section className="bg-white min-h-screen font-sans pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        {/* Coupon Alert */}
        <div
          className="bg-[#F6F6F6] p-6 rounded-xl mb-12 border-l-4
        border-[#F57005]"
        >
          <p className="text-[#2A254D] font-medium font-urbanist text-[18px]">
            Have a coupon?{" "}
            <span
              className="text-[#F57005] font-bold cursor-pointer
            hover:underline"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7">
            <h3
              className="text-[#2A254D] text-3xl font-bold mb-8
            font-urbanist"
            >
              Billing Details
            </h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-16 items-start">
          ...
          <div className="border border-[#E4E4E4] rounded-2xl p-8 shadow-sm bg-white h-full">
            ...
            <div className="space-y-5">
              <div className="flex justify-between border-b border-[#E4E4E4] pb-4 font-bold
              text-[#2A254D] font-urbanist">
                <span>Product</span>
                <span>Price</span>
              </div>
              ...
              <div className="flex justify-between text-2xl font-extrabold text-[#2A254D]
              border-t border-[#E4E4E4] pt-5 font-urbanist">
                <span>Total</span>
                <span>$20.00</span>
              </div>
            </div>
          ...
          <div className="flex flex-col h-full">
            <div className="space-y-4 bg-[#F6F6F6] p-8 rounded-xl grow">
              ...
              >
                ...
                <div>
                  <p className="font-bold text-[#2A254D] text-lg">
